...
<article className="mt-14 sm:w-4/5 sm:m-auto sm:mt-12">
    <div className="flex items-center mb-4 space-x-4">
        <img className="w-10 h-10 rounded-full" src="src/assets/images/coucica 1.png" alt=""></img>
        <div className="space-y-1 font-medium dark:text-dark">
            <p>Jese Leos <time dateTime="2014-08-16 19:00" className="block text-sm text-dark-500 dark:text-dark-400">Joined
                    on August
                    2014</time></p>
        </div>
    </div>
    <div className="flex items-center mb-1">
        ...
        <h3 className="ml-2 text-sm font-semibold text-gray-900 dark:text-dark">Thinking to buy
            another one!</h3>
    </div>
