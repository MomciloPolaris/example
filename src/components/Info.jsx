...
<section className="w-full">
    <Container>
        <div className="FlexContainer flex justify-between sm:flex-wrap">
            <div className="ImageWrapper relative sm:w-32 sm:order-1 sm: sm:mb-6 sm:ml-16">
                <div
                    ...
                    <img className="m-auto mt-16" src="src/assets/images/Pen.png" alt="Pen" />
                </div>
            ...
            <div className="About sm:order-3 sm:m-auto sm:mb-6">
                ...
                <div id="Starting" className="flex justify-between">
                    <p className="text-sm mt-3 font-bold w-24 inline-block">STARTING AT:</p>
                    <p id="Coins" className="inline-block text-xl font-bold mt-1">499 <img className="inline-block"
                            src="src/assets/images/Coins.png" alt="Coins" /></p>
                </div>
                <button
                    className="w-64 h-12 bg-[#f59e0b] text-[#f8fafc] font-bold text-lg rounded-lg mt-5 hover:scale-95 ease-in-out duration-300">Book
                    a
                    session</button>
            </div>
            ...
            <div id="Bookmark" className="sm:order-2 sm:mr-14">
                <p className=" sm:mt-14 text-[#737373] font-bold text-sm cursor-pointer"><img
