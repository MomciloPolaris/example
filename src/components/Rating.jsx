...
<div id="RatingCoach" className="sm:w-4/5 sm:m-auto">
    ...
    <div id="RatingContent" className="mt-10">
        <div className="flex items-center ">
            <svg aria-hidden="true" className="w-5 h-5 FF9F1C" fill="currentColor" viewBox="0 0 20 20"
            ...
            <svg aria-hidden="true" className="w-5 h-5 text-gray-300 dark:text-white-500" fill="currentColor"
            ...
            <p className="ml-2 text-sm font-medium text-white-500 white:text-white-400">4.95 out of 5
            </p>
        </div>

        <p className="text-sm font-medium text-white-500 white:text-white-400 mt-6">1,745 global
            ratings</p>
        <div className="flex items-center mt-4">
            <span className="text-sm font-medium text-blue-600 dark:text-blue-500">5 star</span>
            <div className="w-2/4 h-5 mx-4 bg-gray-200 rounded dark:bg-white-700 sm:w-4/6">
